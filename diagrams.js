...
(function () {
  ...
  // ---- Gusset dimensions (D/E/R/H callouts, Part 3) -- user-supplied
  // original artwork (their own redrawing, not sourced from the FIA PDF).
  D["gusset-dims"] = wrapImg("gusset_dimensions.png");
